...
import com.jyuka.dto.response.UserAccountClientResponse;
...
class UserAccountManagementServiceTest {
    ...
    @RestClientTest(UserAccountManagementService.class)  // RestClient 를 mock 처리를 위함, 테스트할 대상 : UserAccountManagementService
    @Nested
    class RestTemplateTest {
        ...
        void givenNothing_whenCallingUserAccountsApi_thenReturnsUserAccountList() throws Exception {
            // Given
            UserAccountDto expectedUserAccount = createUserAccountDto("jyuka", "jyuka");
        ...
        void givenUserAccountId_whenCallingUserAccountApi_thenReturnsUserAccount() throws Exception {
            // Given
            String userId = "jyuka";
            UserAccountDto expectedUserAccount = createUserAccountDto(userId, "jyuka");
            server
